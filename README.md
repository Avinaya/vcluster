...
- Python client message generator `publish` 

And one subscriber: 
 
- Python subscriber `subscribe`
...
```bash
dapr run --app-id app-subscribe --resources-path ../components/ --app-port 6001 -- python3 app.py
```
...
```bash
dapr run --app-id publish --resources-path ../components/ -- python3 app.py
```

<!-- END_STEP -->

```bash
dapr stop --app-id publish-http
dapr stop --app-id subscribe-http
```
